...
parser.add_argument('--model', help='Pointer to path of the saved Keras model', type=str)
...
if __name__ == "__main__":
    ...
    model2 = load_saved_model(model)
    class_names = load_class_names(class_label_map)
    
    print(predict(image_path, model2, K, class_names))